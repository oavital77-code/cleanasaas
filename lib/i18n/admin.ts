...
const SESSIONS_HE = {
  ...
  // רישום תשלום ידני
  awaitingPaymentHint: "אושרה ומחכה לתשלום. כשהתשלום מגיע — רושמים אותו כאן, והמשבצות ננעלות.",
  ...
  recordPaymentError: "רישום התשלום נכשל",
  // /admin/sessions/new
  newTitle: "קביעת ססיה חופשית",
  directAssignTitle: "שיבוץ ישיר, ללא בדיקת התנגשות",
  directAssignDescription:
    'משמש בעיקר לקליטת מטפל/ת ותיק/ה שכבר יש לה משבצות קבועות. נכנס ישר ל"ממתין לתשלום" — ואז רושמים את התשלום ברשימת הססיות.',
...
const SETTINGS_HE = {
  ...
  tierNotices: {
    ...
    pricing_invalid: "תמחור הססיה לא נשמר — שעות בקפיצות של חצי שעה, מינימום לא גבוה מהמקסימום, ומחיר אי-שלילי.",
    pricing_error: "שמירת מחירי הססיה נכשלה — נסו שוב.",
  ...
  sessionPricingDescription:
    "המטפל/ת בוחר/ת כמה שעות שבועיות בתוך הטווח, והמחיר החודשי מחושב לפי מספר השעות. מינימום ומקסימום שווים = גודל ססיה קבוע.",
  sessionMinHours: "מינימום שעות שבועיות",
  sessionMaxHours: "מקסימום שעות שבועיות",
  sessionPricePerHour: "מחיר לשעה שבועית, לחודש (₪, לפני מע\"מ)",
  sessionPricingExample: (hours: number, price: string) => `לדוגמה: ${hours} שעות שבועיות = ${price} לחודש + מע"מ`,

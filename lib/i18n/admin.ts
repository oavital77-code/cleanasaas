...
const SETTINGS_HE = {
  ...
  tierNotices: {
    ...
    pricing_invalid: "מחירי הססיה לא נשמרו — שעות בסיס: מספר שלם 1–1000, מחיר: מספר אי-שלילי.",
...
const SETTINGS_EN: typeof SETTINGS_HE = {
  ...
  tierNotices: {
    ...
    pricing_invalid: "Session pricing was not saved — base hours: a whole number 1–1000, price: a non-negative number.",

 ...
 * לקוחות מייל לא תומכים ב-CSS מודרני. צבעי המותג (violet) של Cleana, לא של
 * הקליניקה השולחת — זה מייל של הפלטפורמה, לא של קליניקה ספציפית.
 */
...
<body style="margin:0;padding:0;background:#f4f1fe;font-family:Arial,Helvetica,sans-serif;direction:rtl;">
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e8eaf0;">
          ...
          <tr>
            <td style="padding:28px;color:#1b1e27;font-size:15px;line-height:1.75;text-align:right;">
              ${bodyHtml}
            </td>
          </tr>
          <tr>
            <td style="padding:16px 28px;background:#f4f1fe;color:#6b7288;font-size:12px;text-align:right;">
